...
class HeaderBar(Static):
    ...
    def __init__(self, *, device_id: str, organization_id: str) -> None:
    ...
    def render(self) -> Text:
        ...
        text.append(_short(self._organization_id, 12), style="#d8ccf0")
...
class StatusPane(VerticalScroll):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield Static(self._kv_text("Organization", self._creds.organization_id))
...
class XelosTUI(App):
    ...
    def compose(self) -> ComposeResult:
        yield HeaderBar(
            ...
            organization_id=str(self._creds.organization_id),
        )
